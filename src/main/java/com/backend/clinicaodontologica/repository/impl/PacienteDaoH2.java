...
public class PacienteDaoH2 implements IDao<Paciente> {
    ...
    public Paciente registrar(Paciente paciente) {
        ...
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO PACIENTES (NOMBRE, " +
                    "APELLIDO, DNI, FECHA, DOMICILIO_ID) VALUES (?, ?, ?, ?, ?)", Statement.RETURN_GENERATED_KEYS);
    ...
    private Paciente crearObjetoPaciente(ResultSet resultSet) throws SQLException {
        ...
        return new Paciente(resultSet.getInt("id"), resultSet.getString("nombre"), resultSet.getString("apellido"),
