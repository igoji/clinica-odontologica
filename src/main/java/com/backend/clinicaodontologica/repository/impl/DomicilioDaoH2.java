...
public class DomicilioDaoH2 implements IDao<Domicilio> {
    ...
    public Domicilio registrar(Domicilio domicilio) {
        ...
        try {
            ...
            domicilioRegistrado = new Domicilio(domicilio.getCalle(), domicilio.getNumero(), domicilio.getLocalidad()
    ...
    private Domicilio crearObjetoDomicilio(ResultSet resultSet) throws SQLException {
        ...
        return new Domicilio(resultSet.getInt("id"), resultSet.getString("calle"), resultSet.getInt("numero"),
